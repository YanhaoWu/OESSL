...
def default_argument_parser(epilog=None):
    ...
    parser.add_argument('--config-file', default="/home/WuYanhao/WorkSpace/Pointcept/configs/scannet/pretrain-msc-v1m1-0-spunet-base.py", metavar="FILE", help="path to config file")
